...
class SceneContext:
    ...
    @overload
    def query[C1](self, component_type: type[C1]) -> Iterable[tuple[Entity, tuple[C1]]]: ...

    @overload
    def query[C1, C2](self, first_component_type: type[C1], second_component_type: type[C2]) -> Iterable[tuple[Entity, tuple[C1, C2]]]: ...

    @overload
    def query[C1, C2, C3](self, first_component_type: type[C1], second_component_type: type[C2], third_component_type: type[C3]) -> Iterable[tuple[Entity, tuple[C1, C2, C3]]]: ...

    @overload
    def query[C1, C2, C3, C4](self, first_component_type: type[C1], second_component_type: type[C2], third_component_type: type[C3], fourth_component_type: type[C4]) -> Iterable[tuple[Entity, tuple[C1, C2, C3, C4]]]: ...
