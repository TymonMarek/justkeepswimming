...
class SceneContext:
    ...
    @overload
    def get_components[C1](self, component_type: type[C1]) -> Iterable[tuple[Entity, tuple[C1]]]: ...

    @overload
    def get_components[C1, C2](self, first_component_type: type[C1], second_component_type: type[C2]) -> Iterable[tuple[Entity, tuple[C1, C2]]]: ...

    @overload
    def get_components[C1, C2, C3](self, first_component_type: type[C1], second_component_type: type[C2], third_component_type: type[C3]) -> Iterable[tuple[Entity, tuple[C1, C2, C3]]]: ...

    @overload
    def get_components[C1, C2, C3, C4](self, first_component_type: type[C1], second_component_type: type[C2], third_component_type: type[C3], fourth_component_type: type[C4]) -> Iterable[tuple[Entity, tuple[C1, C2, C3, C4]]]: ...

    def get_components(self, *classes: type[Component]) -> Iterable[tuple[Entity, tuple[Component, ...]]]: # type: ignore (See https://discuss.python.org/t/pre-pep-considerations-and-feedback-type-transformations-on-variadic-generics/50605)
