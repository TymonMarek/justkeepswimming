...
class ButtonComponent(Component):
    ...
    label_color_hover: Color = field(
        default_factory=lambda: Color(200, 200, 200)
    )
    background_color_hover: Color = field(
        default_factory=lambda: Color(50, 50, 50)
    )
    label_color_active: Color = field(
        default_factory=lambda: Color(237, 235, 235)
    )
    background_color_active: Color = field(
        default_factory=lambda: Color(15, 15, 15)
    )
    active: bool = False
    hovering: bool = False
