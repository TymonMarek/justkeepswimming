...
class SpearPrefab(Prefab):
    extends = CharacterPrefab()
    components = [
        SpritesheetComponent(
            {
                AnimationType.IDLE: Animation(
                    image=Image(Path("assets/spritesheets/spear.png")),
                    ...
                    sequence=KeyframeSequence(
                        [
                            Keyframe(
                                0,
                                Frame(SPEAR_GRID.cell(0, 0)),
                            ),
                            Keyframe(
                                0.25,
                                Frame(SPEAR_GRID.cell(0, 1)),
                            ),
                            Keyframe(
                                0.5,
                                Frame(SPEAR_GRID.cell(0, 2)),
                            ),
                            Keyframe(
                                1.00,
                                Frame(SPEAR_GRID.cell(0, 3)),
                            ),
                        ]
                    ),
                ),
                AnimationType.REVERSE_WALK: Animation(
                    ...
                    sequence=KeyframeSequence(
                        [
                            Keyframe(
                                0.0,
                                Frame(SPEAR_GRID.cell(1, 3)),
                            ),
                            Keyframe(
                                0.33,
                                Frame(SPEAR_GRID.cell(1, 2)),
                            ),
                            Keyframe(
                                0.66,
                                Frame(SPEAR_GRID.cell(1, 1)),
                            ),
                            Keyframe(
                                1,
                                Frame(SPEAR_GRID.cell(1, 0)),
                            ),
                        ]
                    ),
                ),
                ...
                AnimationType.ATTACK: Animation(
                    ...
                    sequence=KeyframeSequence(
                        [
                            Keyframe(
                                0,
                                Frame(SPEAR_GRID.cell(2, 0)),
                            ),
                            Keyframe(
                                0.2,
                                Frame(SPEAR_GRID.cell(2, 1)),
                            ),
                            Keyframe(
                                0.4,
                                Frame(SPEAR_GRID.cell(2, 2)),
                            ),
                            Keyframe(
                                0.6,
                                Frame(SPEAR_GRID.cell(2, 3)),
                            ),
                            Keyframe(
                                0.8,
                                Frame(SPEAR_GRID.cell(2, 4)),
                            ),
                            Keyframe(
                                1.0,
                                Frame(SPEAR_GRID.cell(2, 5)),
                            ),
                        ]
                    ),
                ),
                AnimationType.HURT: Animation(
                    ...
                    sequence=KeyframeSequence(
                        [
                            Keyframe(
                                0,
                                Frame(SPEAR_GRID.cell(3, 0)),
                            ),
                            Keyframe(
                                1,
                                Frame(SPEAR_GRID.cell(3, 1)),
                            ),
                        ]
                    ),
                ),
                AnimationType.DEATH: Animation(
                    ...
                    sequence=KeyframeSequence(
                        [
                            Keyframe(
                                0,
                                Frame(SPEAR_GRID.cell(4, 0)),
                            ),
                            Keyframe(
                                0.2,
                                Frame(SPEAR_GRID.cell(4, 1)),
                            ),
                            Keyframe(
                                0.4,
                                Frame(SPEAR_GRID.cell(4, 2)),
                            ),
                            Keyframe(
                                0.6,
                                Frame(SPEAR_GRID.cell(4, 3)),
                            ),
                            Keyframe(
                                0.8,
                                Frame(SPEAR_GRID.cell(4, 4)),
                            ),
                            Keyframe(
                                1.0,
                                Frame(SPEAR_GRID.cell(4, 5)),
                            ),
                        ]
                    ),
                ),
        ...
        TransformComponent(
            position=Vector2((1920 / 3) / 3, (1080 / 3) / 2),
            size=Vector2(50, 50),
