from justkeepswimming.backgrounds.mines import MinesBackgroundPrefabGroup
...
async def load(
    ...
    scene.actions = [
        ...
        InputAction(
            InputActionId.PLAYER_TURN_LEFT, "Rotate left", [KeyboardKeyType.A]
        ),
        InputAction(
            InputActionId.PLAYER_MOVE_DOWN, "Move down", [KeyboardKeyType.S]
        ),
        InputAction(
            InputActionId.PLAYER_TURN_RIGHT, "Rotate right", [KeyboardKeyType.D],
        ),
    ]
